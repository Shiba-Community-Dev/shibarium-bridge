...
//Setup and config functions
 ...
 function startGeth() {
     ...
     exec('bin\\geth.exe --datadir="bin\\shibarium" --networkid 20210 --http --http.port 8545 --http.api "eth,net,web3, personal" --http.corsdomain "*" --bootnodes "enr:-J24QC5A7oB1syQdXddcwkgkZiRz571KHWxK-Q7hnWzbEtvQRtsZPb9nhrqPrnOFolSNeoYDL60-ir-dPFY-vDycKogCg2V0aMfGhC6e4G6AgmlkgnY0gmlwhI_GP7WJc2VjcDI1NmsxoQJyQQNS9_tLwqoMGnDQx6Rj_eovJU290FuhhgtRBQv2cYRzbmFwwIN0Y3CCndODdWRwgp3T"', (error, stdout, stderr) => {
        if (error) {
            console.log(`<error: ${error.message}`)
            return false
        }
